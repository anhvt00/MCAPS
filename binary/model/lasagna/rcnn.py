...
sid = 0
seq_size = 2000
emb_files = ['../../../embeddings/default_onehot.txt', '../../../embeddings/string_vec5.txt', '../../../embeddings/string_vec7.txt','../../../embeddings/vec5_CTC.txt', '../../../embeddings/vec7_CTC.txt' ,'../../../embeddings/CTC_onehot.txt']
use_emb = 0
hidden_dim = 25
n_epochs=50
