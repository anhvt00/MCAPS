...
sid = 0
seq_size = 2000
emb_files = ['../../../embeddings/oh.txt', '../../../embeddings/ac5.txt', '../../../embeddings/ac7.txt','../../../embeddings/ac5_aph.txt', '../../../embeddings/ac7_aph.txt' ,'../../../embeddings/aph_oh.txt', '../../../embeddings/aph.txt','../../../embeddings/aph_oh_order.txt', '../../../embeddings/ac5_aph_oh.txt']
use_emb = 0
hidden_dim = 25
n_epochs=50
